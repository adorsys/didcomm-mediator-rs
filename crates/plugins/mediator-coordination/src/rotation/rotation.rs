...
mod test {
    ...
    use didcomm::{
        secrets::SecretsResolver, FromPrior, Message, PackEncryptedOptions, UnpackOptions,
    };
    use serde_json::json;
    use uuid::Uuid;
    ...
    async fn test_did_rotation() {
        ...
        let (msg, _) = msg
            .pack_encrypted(
                ...
                None,
                &state.did_resolver,
                &new_secrets_resolver(), // should be new_did_secrets
        ...
        let secrets_resolver = new_secrets_resolver();
